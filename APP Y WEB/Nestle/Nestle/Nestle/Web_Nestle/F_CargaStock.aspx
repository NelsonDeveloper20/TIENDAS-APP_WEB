<%@ Page Title="" Language="C#" MasterPageFile="~/MenuPrincipal.Master" AutoEventWireup="true" CodeBehind="F_CargaStock.aspx.cs" Inherits="Web_Nestle.F_CargaStock" %>
...
<asp:ScriptManager ID="ScriptManager" runat="server" />         
    ...
    margin-top: 7px;">
                     <br style="clear:both;"/> <div class="custom-file">
  ...
  <label class="custom-file-label" for="inputGroupFile01">Seleccione Txt ...</label>
                ...
                <div class="form-group col-md-2">
                      <label><br /></label><br style="clear:both"/>
                <asp:LinkButton ID="LinkButton1" ClientIDMode="Static" CssClass="btn btn-success" runat="server" OnClick = "Unnamed1_Click" ><i class="fa fa-upload"></i> Subir</asp:LinkButton>
                    ...
                    <asp:GridView ID="GvStock" class="table table-bordered" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
