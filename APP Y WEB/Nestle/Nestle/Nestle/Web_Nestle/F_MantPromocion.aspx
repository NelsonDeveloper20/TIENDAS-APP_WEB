<%@ Page Title="" Language="C#" MasterPageFile="~/MenuPrincipal.Master" AutoEventWireup="true" CodeBehind="F_MantPromocion.aspx.cs" Inherits="Web_Nestle.F_MantPromocion" %>
...
<h6 class="m-0">Condicion</h6>    
        ...
        <Columns>
                ...
                <EditItemTemplate>
                <asp:TextBox ID="txtGrupo" Enabled="false" runat="server" onKeyPress="return soloNumeros(event)" class="form-control " Text='<%# Eval("Grupo")%>'/>
                </EditItemTemplate>
                <FooterTemplate>
                <div class="input-group">
                <asp:TextBox ID="txtGrupo_ins" onKeyPress="return soloNumeros(event)" runat="server"  class="form-control "/>
                <asp:LinkButton ID="btnAdd" CommandName="AddNew" CssClass="btn btn-outline-primary" runat="server"><i class="fa fa-plus" aria-hidden="true"></i></asp:LinkButton>
                </div> 
                </FooterTemplate>
                    <ItemStyle Width="15%" />
 ...
 <FooterStyle Width="15%" CssClass="foote" />     
     ...
     <div class="col-lg-5" style="      padding-right: 7px;    padding-left: 2px;">  
      ...
      <asp:GridView runat="server" ID="GvDemo2" ShowFooter="True" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="IdPromocionBonificacion,IdPromocion"
           OnPageIndexChanging="gvDetails_PageIndexChanging"  class="table table-bordered" OnRowCommand ="GvDemo2_RowCommand" 
