...
{
    public partial class F_MantPromocion : System.Web.UI.Page
    {
...
Promociones obj_promocion = new Promociones();
        ...
        #region cargar demo_condicion
        protected void cargarDemoCondicion()
        {

            DataSet ds = new DataSet();
            ds = obj.ListarDemCondicion(Convert.ToInt32(Request.Cookies["WebNestle"]["DLIdUsuario"]));
            if (ds.Tables[0].Rows.Count > 0)
            {
                gvDetails.DataSource = ds;
                gvDetails.DataBind();
                Gv_Condicion.DataSource = ds;
            ...
            ds2 = obj.Listardeo_Boni(Convert.ToInt32(Request.Cookies["WebNestle"]["DLIdUsuario"]));
            if (ds2.Tables[0].Rows.Count > 0)
            {
                GvDemo2.DataSource = ds2;
                GvDemo2.DataBind();
                Gv_Bonficiacion.DataSource = ds2;
            ...
            else
            {
                ...
                GvDemo2.DataSource = ds2;
                GvDemo2.DataBind();
                int columncount = GvDemo2.Rows[0].Cells.Count;
                GvDemo2.Rows[0].Cells.Clear();
                GvDemo2.Rows[0].Cells.Add(new TableCell());
                GvDemo2.Rows[0].Cells[0].ColumnSpan = columncount;
                GvDemo2.Rows[0].Cells[0].Text = "No Records Found";
                GvDemo2.Rows[0].Cells[0].Style["display"] = "none";
            }
            //LabelSelect
        ...
        protected void gvDetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("AddNew"))
            {
                ...
                //status,  IdUsuario, idpromcondicion,  Cantidad, Descripcion,   IdCat_Prod,  Grupo

                //foreach (GridViewRow row in Gv_Condicion.Rows)
                //{

                //    if (row.Cells[4].Text.ToString() == TxtGrupo.Text.ToString().Trim())
                //    {
                //        String Msj = "Ya existe Grupo ";
                //        string menssajeScript = "<script type='text/javascript'>"
                //                      + " swal({" +

                //              "title: '"+ Msj+ " " + TxtGrupo.Text.ToString() + "'," +
                //               " icon: 'warning'," +
                //              "  dangerMode: true," +
                //         "   })  </script>";
                ...
                //busca_renglon = tabla.Select();

                //    if (busca_renglon.Count() >= 2)
                //    {
                //        //existe el grupo
                //        string msj3 = @"<script type='text/javascript'>
                //           swal({
                //    title: ""Debe pertenecer al grupo existente"",
                //    icon: ""warning"",
                //    dangerMode: true,
                //})
                //      </script>";
                ...
                dtcoun = obj.count_grupo(Convert.ToInt32(TxtGrupo.Text), IdUsuario);
                Int32 TotaklGrupo = 0;
                Int32 Grupo = 0;
                foreach (DataRow row in dtcoun.Rows)
                {
                    TotaklGrupo = Convert.ToInt32(row["count"].ToString());
                    Grupo = Convert.ToInt32(row["grupo"].ToString());
                }
                ...
                Int32 coun = obj.counDistintos(Convert.ToInt32(TxtGrupo.Text), IdUsuario);
                if (coun >= 2)
                {
                    foreach (GridViewRow row in Gv_Condicion.Rows)
                    {
            ...
            }else
            {
                ...
                obj.crudoperations(HdnIp.Value.ToString(), "INSERT", IdUsuario,0,Convert.ToInt32(txtcantidad.Text.ToString()),txtdescripcion.Text.ToString().Trim().ToUpper(),
                   Categoria.ToString(),Convert.ToInt32(TxtGrupo.Text), Prod_Cat.ToString(), Producto.ToString());
                cargarDemoCondicion();
            }
        }
        protected void gvDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            obj.crudoperations(HdnIp.Value.ToString(), "DELETE", 0, IdCondicionDemo, 0, "", "", 0, "", "");
            cargarDemoCondicion();
        ...
        protected void gvDetails_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            //Int32 Rep1 = 0;
            //Rep1= obj.Repr
            ////si hay dos registros distintos no permitir repetidos
            //if (Repr > 1)
            //{
            ...
            //    foreach (GridViewRow row in Gv_Condicion.Rows)
            //    {
            //        if (row.Cells[4].Text.ToString() == TxtGrupo.Text.ToString())
            //        {
            //            String Msj = "Ya existe grupo " + TxtGrupo.Text.ToString();
            //            string menssajeScript = "<script type='text/javascript'>"
            //                          + " swal({" +
...
obj.crudoperations(HdnIp.Value.ToString(), "UPDATE", IdUsuario, Id_DemProm ,Convert.ToInt32(txtcantidad.Text.ToString()), txtdescripcion.Text.ToString().Trim().ToUpper(),
Categoria.ToString(), Convert.ToInt32(TxtGrupo.Text), Prod_Cat.ToString(), Producto.ToString());
           
            gvDetails.EditIndex = -1;
            cargarDemoCondicion();
        }
        #region complementos crud
        protected void gvDetails_RowEditing(object sender, GridViewEditEventArgs e)
        {

            //Label Country = (Label)gvDetails.Rows[e.NewEditIndex].FindControl("lbl_it");

            gvDetails.EditIndex = e.NewEditIndex;
            cargarDemoCondicion();
            //DropDownList ddprod = (DropDownList)gvDetails.Rows[gvDetails.EditIndex].FindControl("DD_Prod_Catedit");
            ...
            ////DropDownList ddcategoria = (DropDownList)gvDetails.Rows[gvDetails.EditIndex].FindControl("DDCategoriaedit");
            ...
            ////ddList.SelectedValue = Country.Text.ToString();

            //ddprod.Items.FindByValue(Country.Text).Selected = true;
        ...
        protected void gvDetails_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //    DropDownList ddList = (DropDownList)e.Row.FindControl("DD_Prod_Catedit");
            //    ddList.DataSource = obj_promocion.ListarProducto(1);
            //    ddList.DataTextField = "Nombre";
            //    ddList.DataValueField = "IdProductoTxt";
            //    ddList.DataBind();
            //    ddList.Items.FindByValue((e.Row.FindControl("lblprod_cat") as Label).Text).Selected = true;
            //}
            ...
            //        string userDeptCode = txtcod_prod.Text.ToString().Trim();
            ...
            {
                DropDownList ddprod = (DropDownList)e.Row.FindControl("DD_Prod_CatIns");
                ddprod.DataSource = obj_promocion.ListarProducto(1);
                ddprod.DataTextField = "Nombre";
                ddprod.DataValueField = "IdProductoTxt";
                ddprod.DataBind();
        ...
        {
            Int32 IdCondicionDemo = Convert.ToInt32(GvDemo2.DataKeys[e.RowIndex].Values["IdPromocionBonificacion"].ToString());
            //string productname = gvDetails.DataKeys[e.RowIndex].Values["productname"].ToString();
            //string status, Int32 IdUsuario, Int32 IdPromocionBoni,
            //String Producto,Int32 Cantidad, Int32 Stock,Int32 Grupo
            obj.CrudOperationBoni(HdnIp.Value.ToString(),"DELETE", 0, IdCondicionDemo, "", 0, 0, 0,"");
            cargarDemoCondicion();
        }
        protected void GvDemo2_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            obj.CrudOperationBoni(HdnIp.Value.ToString(),"UPDATE", IdUsuario, Id_DemPromBoni, DDProducto.SelectedValue.ToString(),
                Convert.ToInt32(txtcantidad.Text.ToString()), Convert.ToInt32(TxtStock.Text.ToString()),
               Convert.ToInt32(TxtGrupo.Text), DDProducto.SelectedItem.Text.ToString());
        ...
        protected void GvDemo2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("AddNew_Boni"))
            {
                Int32 IdUsuario = Convert.ToInt32(Request.Cookies["WebNestle"]["DLIdUsuario"]); //
                ...
                //string status, Int32 IdUsuario, Int32 IdPromocionBoni,  String Producto, Int32 Cantidad,Int32 Stock, Int32 Grupo
                ...
                obj.CrudOperationBoni(HdnIp.Value.ToString(),"INSERT", IdUsuario, 0, DDProducto.SelectedValue.ToString(), 
                    Convert.ToInt32(txtcantidad.Text.ToString()),Convert.ToInt32(TxtStock.Text.ToString()),
                   Convert.ToInt32(TxtGrupo.Text), DDProducto.SelectedItem.Text.ToString());
                cargarDemoCondicion();
            }
        ...
        protected void BtnNuevo_Click(object sender, EventArgs e)
        {
            ...
            Int32 IdUsuario = Convert.ToInt32(Request.Cookies["WebNestle"]["DLIdUsuario"]);
            obj.CrudOperationBoni(HdnIp.Value.ToString(), "DELETE_ALL", IdUsuario, 0, "", 0, 0, 0, "");
            obj.crudoperations(HdnIp.Value.ToString(), "DELETE_ALL", IdUsuario, 0, 0, "", "", 0, "", "");
            cargarDemoCondicion();
        }
        ...
        protected void BtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in Gv_Bonficiacion.Rows)
            {
                ...
                obj_promocion.InsertarBonificacion(IdPormocion,Convert.ToInt32(row.Cells[3].Text.ToString()), row.Cells[0].Text.ToString(),Convert.ToInt32(row.Cells[1].Text.ToString().Trim()),
        ...
        protected void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            Panel_Agregar.Visible = false;
            Int32 IdUsuario_ins = Convert.ToInt32(Request.Cookies["WebNestle"]["DLIdUsuario"]);
            obj.CrudOperationBoni(HdnIp.Value.ToString(),"DELETE_ALL", IdUsuario_ins, 0, "", 0, 0, 0, "");
            obj.crudoperations(HdnIp.Value.ToString(), "DELETE_ALL", IdUsuario_ins, 0, 0, "", "", 0, "", "");
...
/*
            ...
            if (e.CommandName == "Editar")
            {
                ...
                dtprom = obj_promocion.PromocionXid(HdnIp.Value.ToString(),IdPromocion, idusuario);
                ...
                foreach (DataRow row in dtprom.Rows)
                {
                    ...
                    TxtMontoBonifica.Text = row["MontoBonificacion"].ToString();
