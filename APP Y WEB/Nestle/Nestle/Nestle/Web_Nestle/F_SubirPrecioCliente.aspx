<%@ Page Title="" Language="C#" MasterPageFile="~/MenuPrincipal.Master" AutoEventWireup="true" CodeBehind="F_SubirPrecioCliente.aspx.cs" Inherits="Web_Nestle.F_SubirPrecioCliente" %>
...
<asp:ScriptManager ID="ScriptManager" runat="server" />         
            ...
            <h2 class="m-0">Cargar Producto  Tipo Cliente "BODEGA"</h2>    
            </div>
            ...
            <div class="col">
                ...
                <asp:DropDownList ID="DDTipoUsuario" runat="server"  class="form-control tip"  Height="34px"  >
                </asp:DropDownList>
                </div>
                ...
                <asp:LinkButton ID="BtnCancelar" CssClass="btn btn-dark" Width="100%" runat="server" OnClick="BtnCancelar_Click" ><i class="fas fa-angle-double-left"></i> Cancelar</asp:LinkButton>
                    ...
                    <asp:GridView ID="Gv_Producto" class="table table-bordered"  ShowHeaderWhenEmpty="true" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">           
                        <Columns>
                            ...
                            <asp:BoundField DataField="TipoUsuarioValor" HeaderText="Valor" ItemStyle-CssClass="hidden-field" HeaderStyle-CssClass="hidden-field" ><HeaderStyle CssClass="hidden-field"></HeaderStyle><ItemStyle CssClass="hidden-field"></ItemStyle>
                            <FooterStyle CssClass="hidden-field"></FooterStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="TipoUsuario" HeaderText="Tipo Cliente" /> 
                        </Columns>
                        <EmptyDataTemplate>
