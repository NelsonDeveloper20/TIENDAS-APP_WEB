...
public class PedidoDetalle {
    ...
    public PedidoDetalle(String idPedido, String idProductoTxt, String nombrePro, String precio, String cantidad, String subTotal, String idPromocion, String idCondicion, String idBonificacion, String imagen) {
        IdPedido = idPedido;
        IdProductoTxt = idProductoTxt;
        NombrePro = nombrePro;
        Precio = precio;
