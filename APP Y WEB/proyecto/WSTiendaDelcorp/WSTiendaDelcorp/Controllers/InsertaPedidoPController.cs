...
{
    public class InsertaPedidoPController : ApiController
    {
        // GET: api/InsertaPedidoP
        public IEnumerable<string> Get()
        {
            return new string[] { "value1", "value2" };
        }

        // GET: api/InsertaPedidoP/5
        public string Get(int id)
        {
            return "value";
        }

        // POST: api/InsertaPedidoP
        public IHttpActionResult Post(List<PedidoDetalleV3> lista)
        {
            ...
            try
            {
                ...
                Db obj = new Db();
                List<PedidoDetalleV3> lst = new List<PedidoDetalleV3>();
                ...
                dt = obj.InsertarPedidoP(lista[0].IdUsuario,
                                              lista[0].CodigoTxt,
        ...
        // PUT: api/InsertaPedidoP/5
        public void Put(int id, [FromBody]string value)
        {
        }

        // DELETE: api/InsertaPedidoP/5
